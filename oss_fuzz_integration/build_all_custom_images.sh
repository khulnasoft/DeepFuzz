...
rm -rf ./oss-fuzz/infra/base-images/base-clang/deepfuzz/

mkdir ./oss-fuzz/infra/base-images/base-clang/deepfuzz/

cp -rf ../frontends ./oss-fuzz/infra/base-images/base-clang/deepfuzz/frontends
cp -rf ../src ./oss-fuzz/infra/base-images/base-clang/deepfuzz/src
...
if [[ -z ${CLOUD_BUILD_ENV:+dummy} ]]; then
  ...
  # Only build a subset of the oss-fuzz images because deepfuzz
