...
def post_analysis(cg_extended, fuzzer):
    """Converts an extended callgraph into data deepfuzz
    ...
    # Convert extended callgraph to data deepfuzz
...
def convert_cg_to_introspector_data(cg_extended, fuzzer_filename):
    """Converts the PyCG data into deepfuzz data"""
    new_dict = dict()
...
def convert_to_fuzzing_cfg(cg_extended):
    """Translate a CG to something deepfuzz
    post-processing can use.
    """
