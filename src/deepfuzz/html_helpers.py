...
from deepfuzz import utils, constants
from deepfuzz.datatypes import fuzzer_profile
    ...
    <div class="top-navbar">
        <div class="top-navbar-title-wrapper">
            ...
            <div style="margin:0; font-size: 10px">
              ...
              <a href="https://github.com/khulnasoft/deepfuzz/issues"
                 style="color:#FFFFFF;">
                https://github.com/khulnasoft/deepfuzz/issues
              </a>
            </div>
        </div>
    </div>"""
