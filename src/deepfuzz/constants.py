...
GIT_REPO = "https://github.com/khulnasoft/deepfuzz"
GIT_BRANCH_URL = f"{GIT_REPO}/blob/main"

ENGINE_INPUT_FILE = "deepfuzz-engine-input.json"
SUMMARY_FILE = "summary.json"
ALL_FUNCTIONS_JSON = 'all-deepfuzz-functions.json'
ALL_JVM_CONSTRUCTOR_JSON = 'all-deepfuzz-jvm-constructor.json'
