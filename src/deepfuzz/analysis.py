...
from deepfuzz import (cfg_load, code_coverage, constants, data_loader,
                               debug_info, html_helpers, json_report, utils)

from deepfuzz.datatypes import (
    project_profile,
    fuzzer_profile,
    function_profile,
)
...
def extract_all_sources(language):
    ...
    to_avoid = [
        ...
        'third_party', '/build/', '/usr/local/', '/deepfuzz/',
