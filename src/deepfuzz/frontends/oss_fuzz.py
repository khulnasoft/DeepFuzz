...
from deepfuzz.frontends import frontend_c
from deepfuzz.frontends import frontend_cpp
from deepfuzz.frontends import frontend_go
from deepfuzz.frontends import frontend_jvm
from deepfuzz.frontends import frontend_rust
from deepfuzz.frontends.datatypes import Project

from deepfuzz import constants
...
def analyse_folder(
    ...
    if language == constants.LANGUAGES.C:
        ...
        if pairings:
            with open(os.path.join(out, 'exe_to_deepfuzz_logs.yaml'),
                      'w') as f:
