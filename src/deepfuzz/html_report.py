...
from deepfuzz import (analysis, constants, html_constants,
...
def create_fuzzer_detailed_section(
    ...
    from deepfuzz.analyses import calltree_analysis as cta
...
def create_html_report(introspection_proj: analysis.IntrospectionProject,
    ...
    # Write all functions to all-deepfuzz-functions.json
    if dump_files:
        json_report.create_all_fi_functions_json(all_functions_json_report,
                                                 out_dir)

    # Write jvm constructor details to all-deepfuzz-jvm-constructor.json
