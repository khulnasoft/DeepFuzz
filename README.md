[![OpenSSF Scorecard](https://api.securityscorecards.dev/projects/github.com/khulnasoft/deepfuzz/badge)](https://api.securityscorecards.dev/projects/github.com/khulnasoft/deepfuzz)
...
Deepfuzz aims to improve fuzzing experience of a project by guiding on whether you should:
...
The main Fuzz Introspector documentation is available here: https://deepfuzz.readthedocs.io This documentation includes user guides, OSS-Fuzz instructions, tutorials, development docs and more.
...
- Try yourself:
  - [Use with OSS-Fuzz](oss_fuzz_integration#build-deepfuzz-with-oss-fuzz) (Recommended)
  - [Use without OSS-Fuzz](doc/LocalBuild.md)

## Architecture
The workflow of deepfuzz can be visualised as follows:
...
this project in the
[OSSF Security Tooling Working Group](https://github.com/khulnasoft/wg-security-tooling)
meetings.
