...
def save_deepfuzz_report(introspector_report, project_name, date_str):
...
def extract_and_refine_functions(all_function_list, date_str):
    ...
    for func in all_function_list:
        ...
        # There is a bug in DeepFuzz report generation that sets function
...
def extract_project_data(project_name, date_str, should_include_details,
    ...
    # Save the report
    save_deepfuzz_report(introspector_report, project_name, date_str)
