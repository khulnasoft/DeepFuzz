...
def project_profile():
    ...
    if project is not None:
            ...
            if ps.project_name == project.name:
                ...
                if ps.introspector_data is not None:
                    if ps.introspector_url:
                        latest_deepfuzz_report = ps.introspector_url
                    else:
                        latest_deepfuzz_report = get_introspector_url(
        ...
        return render_template(
            ...
            latest_deepfuzz_report=latest_deepfuzz_report,
