...
from deepfuzz import analysis, exceptions

CORRELATION_FILENAME = "exe_to_deepfuzz_logs.yaml"
BASE_PROJ_DIR = "workdir-"

def get_introspector_report_url(project_name, datestr):
    base_url = 'https://storage.googleapis.com/oss-deepfuzz/{0}/inspector-report/{1}/fuzz_report.html'
...
def get_project_url(project_name, day_offset=-1):
    base_url = 'https://storage.googleapis.com/oss-deepfuzz/{0}/inspector-report/{1}/'
...
def get_all_reports(project_names: List[str],
    ...
    for project in project_names:
        ...
        for i in range(1, days_to_analyse):
            ...
            introspector_project = run_deepfuzz_on_dir(workdir, language)
