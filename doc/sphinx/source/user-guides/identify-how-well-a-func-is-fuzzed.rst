...
available `libdwarf OSS-Fuzz report <https://storage.googleapis.com/oss-deepfuzz/libdwarf/inspector-report/20230109/fuzz_report.html>`_

We will use the table available in the `project functions overview <https://storage.googleapis.com/oss-deepfuzz/libdwarf/inspector-report/20230109/fuzz_report.html#Project-functions-overview>`_ section.
