...
For an example, consider the following calltree (taken from this `report <https://storage.googleapis.com/oss-deepfuzz/htslib/inspector-report/20230124/fuzz_report.html#call_tree_0>`_):
...
The page this takes us to in the above example is `here <https://storage.googleapis.com/oss-deepfuzz/htslib/inspector-report/20230124/calltree_view_0.html>`_
