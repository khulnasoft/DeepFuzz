...
.. code-block:: bash
    ...
    git clone --recurse-submodules https://github.com/khulnasoft/deepfuzz
    cd deepfuzz
...
Deepfuzz relies on an LTO LLVM pass and this requires us to build a
...
.. code-block:: bash
    ...
    python3 ../../../src/main.py report \
      --target-dir=. \
      --correlation-file=./exe_to_deepfuzz_logs.yaml
